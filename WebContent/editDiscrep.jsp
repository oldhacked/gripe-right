            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="input text-center ">
                        <input type="text" name="mcn" value="${discrepancy.mcn}" placeholder="MCN#" class="form-control formNoBrdrSpacing">
                ...
                <div class="form col-xs-12 col-md-6 ">
                    ...
                    <select name="workCenter" value="" class="form-control formNoBrdrSpacing" id="">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="input text-center">
                        <input type="text" name="system" value="${discrepancy.system}" placeholder="system" class="form-control formNoBrdrSpacing">
                ...
                <div class="col-xs-12 col-md-6">
                    ...
                    <div class="input text-center">
                        <input type="text" name="hours" placeholder="${discrepancy.hours}" class="form-control formNoBrdrSpacing">
                    </div>
       ...
       <div class="row">
        <div class="col-xs-12">
           ...
           <div class="col-xs-12 col-md-6">
            ...
            <div class="input text-center">
                <input type="text" name="gripe" value="${discrepancy.gripe}" placeholder="${discrepancy.gripe}" class="form-control formNoBrdrSpacing">
        ...
        <div class="col-xs-12 ">
            ...
            <div class="input text-center formNoBrdrSpacing">
                <textarea type="text" name="discrepancy" value="${discrepancy.discrepancy}" placeholder="${discrepancy.discrepancy}"  class="form-control formNoBrdrSpacing" rows="8"></textarea>
            </div>
        ...
        <div class="col-xs-12 ">
            ...
            <div class="input text-center formNoBrdrSpacing">
                <textarea type="text" name="resolution" value="${discrepancy.resolution}" placeholder="${discrepancy.resolution}" class="form-control formNoBrdrSpacing" rows="8"></textarea>
            </div>
        ...
        <section id="" class="text-center">
            ...
            <div class="col-xs-12">
                ...
                <ul class="list-inline">
                    <li>
                         <button type="submit" name="mcn" value="updateDisc"
...
<!-------------------VVVVVVVVVVVVVVV WORKING CODE VVVVVVVVVVV------------------------ -->
<!-------------------VVVVVVVVVVVVVVV WORKING CODE VVVVVVVVVVV------------------------ -->
<!-------------------VVVVVVVVVVVVVVV WORKING CODE VVVVVVVVVVV------------------------ -->
<!-------------------VVVVVVVVVVVVVVV WORKING CODE VVVVVVVVVVV------------------------ -->
<!-------------------VVVVVVVVVVVVVVV WORKING CODE VVVVVVVVVVV------------------------ -->
